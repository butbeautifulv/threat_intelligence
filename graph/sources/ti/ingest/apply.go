// Package ingest applies ingestv1 TI messages to Neo4j (graph write path).
package ingest
...
import (
	...
	tiingest "github.com/butbeautifulv/threat_intelligence/graph/sources/ti/internal/ingest"
	"github.com/butbeautifulv/threat_intelligence/graph/sources/ti/internal/repository"
	"github.com/butbeautifulv/threat_intelligence/graph/sources/ti/internal/usecase"
)

// ApplyEnvelope applies a TI envelope after Validate + source checks.
func ApplyEnvelope(ctx context.Context, repo repository.GraphRepository, uc *usecase.Ingestor, env *ingestv1.Envelope) error {
	switch env.Kind {
