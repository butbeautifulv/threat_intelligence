...
test-pkg-domain:
	cd pkg && env -u GOWORK go test ./ti/... ./vuln/domain/... ./lola/domain/... \
		./ds/domain/... ./sbom/domain/... ./nuclei/domain/... ./coderules/domain/...
