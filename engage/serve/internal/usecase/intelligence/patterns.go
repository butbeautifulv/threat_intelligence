...
func AttackPatterns() map[string][]AttackStep {
	return map[string][]AttackStep{
		"web_reconnaissance": {
			...
			{Tool: "katana", Priority: 3, Params: nil},
			{Tool: "gau", Priority: 4, Params: nil},
			{Tool: "gobuster", Priority: 5, Params: map[string]string{"mode": "dir"}},
			{Tool: "nuclei", Priority: 6, Params: map[string]string{"templates": "cves/,misconfiguration/"}},
			{Tool: "nikto", Priority: 7, Params: nil},
		},
		"api_testing": {
