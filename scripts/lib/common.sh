...
VEIL_COMPOSE_FILES="-f deploy/scrape/compose.yml -f deploy/pipeline/compose.yml -f deploy/knowledge/compose.yml -f deploy/knowledge/compose.neo4j-publish.yml"
