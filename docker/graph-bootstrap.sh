...
DEFAULT_PACK_URL="${GRAPH_PACK_DEFAULT_URL:-https://github.com/butbeautifulv/threat_intelligence/releases/download/v0.2.0-graph-pack/threat-intel-graph-v0.2.0.zip}"
