module github.com/butbeautifulv/threat_intelligence/scrape/factory
...
require (
	...
	github.com/butbeautifulv/threat_intelligence/scrape/contract/scrapev1 v0.0.0 // indirect
