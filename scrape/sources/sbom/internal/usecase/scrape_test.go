...
func TestPublishOSV_kindAndKey(t *testing.T) {
	pub := &mockPub{}
	pl := scrapev1.SBOMOSVRaw{CVE: "CVE-2024-0001", OSVID: "OSV-1", RawJSON: `{}`}
	if err := pub.Publish(context.Background(), scrapev1.KindSBOMOSVJSON, "sbom:osv:CVE-2024-0001", pl); err != nil {
		t.Fatal(err)
	}
	if pub.kind != scrapev1.KindSBOMOSVJSON {
