...
DEFAULT_PACK_URL="${GRAPH_PACK_DEFAULT_URL:-https://github.com/butbeautifulv/threat_intelligence/releases/download/v0.3.2-graph-pack/threat-intel-graph-v0.3.2.zip}"
