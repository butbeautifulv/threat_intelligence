...
|----|------------|------------------|-----|
| P0 | `engage/client-native-p00-mcp-topology` | Новый `docs/engage/engage-mcp-topology.md` | Диаграмма: Cursor → stdio MCP → engage → `exec` на **том же** хосте; явный anti-pattern «remote engage + local nmap без RPC» |
| P1 | `engage/client-native-p01-hexstrike-contract` | `docs/engage/engage-client-dependencies.md` | Таблица: группа инструментов ↔ команда проверки ↔ ссылка на блок README hexstrike (Core / Cloud / Browser) |
...
| ID | Slug | Файлы | DoD |
|----|------|-------|-----|
| P3 | `engage/client-native-p03-execution-profile-env` | `engage/serve/internal/config` или security init, `docs/engage/engage-runtime.md` | `ENGAGE_EXECUTION_PROFILE=client-native` — единственный поддерживаемый профиль для MCP/пентест; краткая заметка о миграции со старых compose (runner удаляется в P12–P14) |
...
| ID | Slug | Файлы | DoD |
|----|------|-------|-----|
| P17 | `engage/client-native-p17-mcp-agents` | [`docs/agents/mcp-agents.md`](docs/agents/mcp-agents.md) | Сценарий: Cursor + stdio + инструменты на хосте |
| P18 | `engage/client-native-p18-runtime-rewrite` | [`docs/engage/engage-runtime.md`](docs/engage/engage-runtime.md) | Удалить/сжать «runner profile» как основной путь |
...
| P22 | `engage/client-native-p22-audit-signoff` | [`docs/engage/engage-audit-report.md`](docs/engage/engage-audit-report.md) | Поддерживаемое исполнение: **только** client-native / host PATH; docker-runner снят с поддержки |
...
|-------|--------|--------|-------|
| P0 | `engage/client-native-p00-mcp-topology` | **merged main** | `docs/engage/engage-mcp-topology.md` |
| P1 | `engage/client-native-p01-hexstrike-contract` | **merged main** | `docs/engage/engage-client-dependencies.md` |
...
| P17–P20 | `main` | **merged main** | Product docs updated for client-native default: `docs/agents/mcp-agents.md`, `docs/engage/engage-runtime.md`, `AGENTS.md`, `README.md` |
| P21–P22 | `main` | **merged main** | `.cursor/agents/manifest.yaml` updated with engage-v3 phase bindings; `docs/engage/engage-audit-report.md` signed off on client-native-only execution |
